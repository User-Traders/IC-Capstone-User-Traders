      ...
      <v-card width="500" class="mx-auto ">
        ...
        <v-card-text>
          <v-form ref="form" v-model="valid" lazy-validation>
            ...
            <v-text-field v-model="password" :counter="10" :rules="passwordRules" label="password" prepend-icon="mdi-lock" required type="password"></v-text-field>
          </v-form>
        </v-card-text>
        <v-divider> </v-divider>
        <v-card-actions>
          <v-btn :disabled="!valid" color="grey" class="mr-3 white--text" @click="validate">
            Go to Login
